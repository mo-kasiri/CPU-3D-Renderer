...
// vec3_t* vec3_from_vec4(const vec4_t *v, const unsigned int n)
// {
//     for(int i=0; i < n; i++)
//     {
...
// vec3_t get_normal(vec3_t *vec)
// {
//     vec3_t v1 = vec3_sub(vec[1], vec[0]);
//     vec3_t v2 = vec3_sub(vec[2], vec[1]);

//     vec3_t cross = vec3_cross(v1, v2);
//     float lenght = vec3_length(cross);
//     vec3_t normal = vec3_mul(cross, 1.0 / lenght);
//     return normal;
// }
